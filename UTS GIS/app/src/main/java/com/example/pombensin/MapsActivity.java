...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getlokasi(){
        String url = "https://pombensin.000webhostapp.com/pombensin.php";
                        ...
                        for (int i = 0; i < jumData; i++) {
                            try {
                                ...
                                mMap.addMarker(new MarkerOptions()
                                        .position(latLng[i])
                                        .title(nama[i])
                                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.pom1))
                                        .snippet(alamat[i]));
                                ...
                                for(int i = 0;i<jumData;i++){
                                    if(marker.getTitle().equals(nama[i])){
                                        if(MarkerD[i]){
                                            ...
                                            DetailActivity.Latitude=longitude[i];
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this, "silakan klik sekali lagi utuk detail", Toast.LENGTH_LONG);
